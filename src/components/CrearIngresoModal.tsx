          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <button
                ...
                className="h-[52px] px-4 bg-white/50 dark:bg-neutral-900/50 border border-black/10 dark:border-white/10 rounded-xl hover:border-primary transition-all text-content font-semibold"
              >
                {monedaSeleccionada.codigo}
                <ChevronDown size={16} className="inline ml-1 text-content/60" />
              </button>
            </div>
          </div>
