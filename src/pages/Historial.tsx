...
export default function Historial() {
  ...
  const transaccionesFiltradas = filtros.descripcion
    ? transacciones.filter((t: Transaccion) => 
        t.motivo?.toLowerCase().includes(filtros.descripcion.toLowerCase()) ||
        t.concepto?.toLowerCase().includes(filtros.descripcion.toLowerCase())
      )
    : transacciones;
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-content">Resultados ({transaccionesFiltradas.length})</h2>
            ...
            {/* Paginación */}
            {!isLoading && transaccionesFiltradas.length > 0 && (
